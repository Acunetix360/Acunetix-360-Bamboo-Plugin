...
public class Acunetix360ScanTaskConfigurator extends AbstractTaskConfigurator {
    ...
    private void populateForAll(@NotNull Map<String, Object> context) throws MalformedURLException, URISyntaxException {
        ...
        if (websiteModelRequest.HasError()) {
            if (!configManager.hasCredentials()) {
                context.put(WebsiteModelRequest.ERROR_MESSAGE_Literal, "Please, validate your credentials from Acunetix 360 global settings.");
            } else {
